...
const HeroSection = () => {
    ...
    return (
        <div className="max-w-screen-2xl w-full h-[758px] mx-auto bg-darkBlue -mt-20 flex flex-row-reverse">
            <div className="w-1/2 bg-darkCyan heroSectionShadow rounded-br-[379px] flex justify-center items-center">
                <div className="w-[500px] h-[500px] bg-darkYellow rounded-full EllipseShadowInit flex justify-center items-center">
                    <img
                        ...
                        className="w-[300px] h-[400px] -rotate-[15deg] hover:scale-105 transition-all duration-300"
                        src={Chips}
                        alt="product"
                    />
                </div>
            ...
            <div className="w-1/2 flex items-center pr-40">
                <div className="w-full h-fit flex flex-wrap gap-y-32 font-Vazir">
                    <div className="w-full h-fit text-white font-semibold flex flex-wrap gap-y-4">
                        <HeroSectionTitle />
